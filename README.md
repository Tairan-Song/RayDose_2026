...
RayDose_2026 is a research framework for three-dimensional photon dose predicition from planning CT images. 

The project explores deep learning methods for efficient rdiotherapy dose estimation, with a focus on spatial context learning, and anatomically informed representations.
...
The objective is to predict clinically relevant three-dimensional photon dose distributions directly
